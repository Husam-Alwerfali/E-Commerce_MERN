...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-zinc-900 dark:to-zinc-800 text-white py-16 mb-8">
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        {products.length === 0 && !loading && !error && (
          <div className="text-center py-16">
            <TrendingUp className="w-20 h-20 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
            <h3 className="text-2xl font-medium text-gray-600 dark:text-gray-300 mb-2">
